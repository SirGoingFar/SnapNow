 ...
 * */
@TargetApi(21)
class ApiLevel21AndAboveCameraManager(
    private val activity: Activity,
    private val textureView: AutoFitTextureView
) {

    private var mAutoFocusSupported: Boolean = false
...
// These values represent Camera states.
        ...
        /**
         * Max preview width that is guaranteed by ai.kudi.agent.picture_picker.custom.com.sirgoingfar.snapnow.camera.custom.ApiLevel21AndAboveCameraManager API
         */
        private const val MAX_PREVIEW_WIDTH = 1920

        /**
         * Max preview height that is guaranteed by ai.kudi.agent.picture_picker.custom.com.sirgoingfar.snapnow.camera.custom.ApiLevel21AndAboveCameraManager API
         */
    ...
    private val cameraStateCallback = object : CameraDevice.StateCallback() {
        override fun onOpened(camera: CameraDevice) {
            this@ApiLevel21AndAboveCameraManager.cameraDevice = camera
            createPreviewSession()
        }

        override fun onDisconnected(camera: CameraDevice) {
            camera.close()
            this@ApiLevel21AndAboveCameraManager.cameraDevice = null
        }
    ...
    private fun openCamera(width: Int, height: Int) {
        ...
        } else Log.e("CustomCameraManager", "Requires Camera Permission")
    }
        ...
        try {
            for (cameraId in cameraManager.cameraIdList) {
                ...
                if (cameraFacing == this.cameraFacing) {
                    ...
                    //check if the autoFocus is supported in this mode
                    val afAvailableModes = cameraManager.getCameraCharacteristics(cameraId)
                        .get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)

                    mAutoFocusSupported = !(afAvailableModes?.size == 0
                ...
                object : CameraCaptureSession.StateCallback() {
                    ...
                    override fun onConfigured(cameraCaptureSession: CameraCaptureSession) {
                        ...
                        try {
                            ...
                            this@ApiLevel21AndAboveCameraManager.cameraCaptureSession =
                            ...
                            this@ApiLevel21AndAboveCameraManager.cameraCaptureSession!!.setRepeatingRequest(
                                captureRequest!!,
